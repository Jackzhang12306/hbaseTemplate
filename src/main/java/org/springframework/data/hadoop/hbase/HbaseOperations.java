...
public interface HbaseOperations {
	...
	<T> List<T> get(String tableName, final List<String> rowName, final String familyName,  final RowMapper<T> mapper);
	<T> List<T> get(String tableName, final List<String> rowName, final RowMapper<T> mapper);
	<T> List<T> get(String tableName, final List<String> rowName, final String familyName, final String qualifier, final RowMapper<T> mapper);
}